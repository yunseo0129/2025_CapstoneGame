...
- **2026년 FIFA 월드컵 (2026.06.11~2026.07.19)**
    ...
    과거 22년 카타르 월드컵 당시 '피파온라인4'의 피시방 점유율이 2배 이상 증가했다.

    평가 : 22년도 예시와 마찬가지로 26년도 월드컵 기간에 축구 관련 게임에 대한 관심이 높아질 것으로 예상된다.
    ...
    출처: https://www.gamevu.co.kr/news/articleView.html?idxno=25237 [김창훈 기자."넥슨 ‘피파온라인4’, 월드컵 대목에 PC방 점유율 2위 굳건히 유지".2022]
...
- **2026년 동계 올림픽 (2026.02.06~2026.02.22)**
    ...
    평가 : 국민적 관심이 높은 국가대표 선수를 모티브로한 게임을 제작하여 관심을 이용한다.
...
- **전쟁에 대한 관심도**
    ...
    평가 : 전쟁에 대한 두려움과 우리나라 안보에 대한 걱정을 자극하는 전쟁 게임을 제작하여 관심을 이용한다.
...
- **현재 Z세대의 주요 게임**
    ...
    평가 : 세대교체에 따라 인기게임의 변화가 발생하므로 현재 Z세대가 선호하는 슈팅게임 장르와 대표게임을 분석하여 반영할 필요가 있다.
...
- **생성형 AI(Generative AI)의 발전**
    ...
    NVIDIA는 게임 NPC에 생동감을 불어넣는 생성형 AI 기술 'ACE(Avatar Cloud Engine)'를 공개했으며, 게임 엔진의 양대 산맥인 Unity 또한 AI를 활용해 텍스처, 애니메이션 등을 제작하는 'Muse'를 출시했다. 이는 메이저 기술 기업들이 게임 개발 파이프라인에 AI를 통합하려는 구체적인 움직임을 보여주는 사례이다. 또한 최근 생성형 AI 발전 속도가 매우 빨라 현재는 생성형 AI가 개발자를 보조하는 도구로만 사용되지만 향후 2, 3년 안에 생성형 AI로만 게임을 만들 가능성도 보인다. 
    
    평가 : 향후 게임 개발에 생성형 AI가 필수적인 요소가 될 것으로 예상되므로, 생성형 AI 기술을 적극적으로 도입하고 활용하는 전략이 필요하다.
...
- **관세 증가로 인한 게임산업의 변화**
    ...
    관세 증가는 게임 산업에 콘솔 기기 가격 인상, 패키지 게임 시장 위축, 한국 게임사들의 판로 개척 필요성 증대 등 부정적 영향을 끼친다. 부정적인 영향의 대표적인 예로 닌텐도 스위치, 플레이스테이션 5 등 콘솔 기기에 최대 25%의 관세가 부과 되어 소비자들은 기기구매에 대한 부담이 늘 수 있다. 그러나 콘솔 시장의 위축은 기존 콘솔 게임 시장의 경쟁을 완화시켜 국내 게임사들이 상대적으로 경쟁력 있는 콘솔 게임을 출시할 수 있는 기회가 될 수 있다. 
    
    평가 : 디지털 게임과 같이 관세 영향을 덜 받는 분야를 고려하여 게임을 제작하는 것이 유리하다.

    출처 : https://www.mk.co.kr/news/world/11308711 [이영욱 기자."‘트럼프 관세’에 취미생활도 비상…소니, 닌텐도 이어 MS까지 콘솔 가격 줄줄이 인상".2025.매일경제]


- **Feel-Conomy (감성 경제)의 부상**
    
    Feel-Conomy(감성 경제)는 소비자들이 제품이나 서비스에 대해 느끼는 감정적 연결과 경험을 중시하는 경제 현상을 의미한다. 이는 단순한 기능적 가치보다 감성적 가치가 소비자 선택에 더 큰 영향을 미친다는 것을 강조한다. 게임 산업에서 Feel-Conomy는 게임 내 스토리텔링, 캐릭터 개발, 몰입형 경험 등을 통해 플레이어와의 감정적 연결을 강화하는 전략으로 나타난다. 예를 들어, 게임 내에서 플레이어가 캐릭터와 깊은 유대감을 형성하거나, 게임 세계에 몰입할 수 있는 요소들을 제공함으로써 플레이어의 만족도와 충성도를 높일 수 있다. 
    
    평가 : 게임 개발 시 감성적 요소를 강화하여 플레이어와의 정서적 연결을 구축하는 것이 중요하다.
    
    출처 : [김난도.트렌드 코리아 2026]

- **Feel-Conomy B급 감성**

    B급 감성은 주류 문화와는 다른 독특하고 개성 있는 스타일을 의미한다. 이는 종종 유머러스하고 풍자적인 요소를 포함하며, 대중문화에서 벗어난 독특한 매력을 지닌다. 게임 산업에서 B급 감성은 독특한 그래픽 스타일, 비주류 스토리라인, 유머러스한 캐릭터 등을 통해 플레이어들에게 새로운 경험을 제공한다. 이러한 요소들은 플레이어들에게 신선한 재미와 흥미를 제공하며, 게임의 차별화된 매력으로 작용할 수 있다. 
   
    'B급 특유의 재미'가 소비자의 경계심을 허물고 긍정적인 감정(Feel)을 유발
    
    평가 : 게임 개발 시 B급 감성을 활용하여 독특하고 개성 있는 게임을 제작하는 것이 중요하다.
    
    출처 : https://www.dbpia.co.kr/pdf/cpViewer?nodeId=T17067925 [윤서영."감성 광고 매체 간 경쟁보완 관계 적소 분석 : B급 감성 광고를 중심으로".2024.한국외국어대학교 대학원]
...
- **DMZ / 접경지역의 생태 시스템 및 지속가능성**
    ...
    평가 : DMZ 및 접경지역을 배경으로 한 게임을 제작할 때, 단순한 군사적 갈등 요소뿐만 아니라 생태적 요소와 사회적 요인들을 통합적으로 반영한다. 예를 들어 현재 UN이 평가한 지속가능발표목표의 진전도가 상당히 낮은 정보를 통해 게임 내에서 지속가능성, 협력, 생태 보전 등의 주제를 다룰 수 있음
...
- **북한 제9차 당대회 (2026.01)**
    ...
    평가 : 제9회 당대회에서 북한의 군사적 위협이 고조될 가능성이 크고, 선거기간 동안 자극적인 정치적 정보 즉 북한에 대한 정보들이 확산될 가능성이 크므로, 게임을 제작할 때 이를 반영한다.



# 결론

2026년에 발생하는 세계적인 이벤트는 올림픽, 월드컵 등이 있지만 우리나라에 오랜기간 영향을 끼치는 요인은 제9회 전국동시지방선거와 북한 제9차 당대회라고 예상한다.
또한 이스라엘-하마스 전쟁 장기화로 인해 전쟁으로 인한 국민들의 우리나라 안보에 대한 관심도가 높아지고 있다.

따라서 지방선거로 인한 여론전으로 정치적 갈등 중심의 자극적인 기사가 많아질 것이고 이때 북한과 관련된 내용이 많아 북한과의 전쟁에 대한 국민들의 관심도가 높아질 것이다. 또한 현재 10대들에게 FPS/TPS 슈팅게임이 꾸준히 인기있기 때문에 6.25 전쟁을 배경으로 한 슈팅게임을 만들려고 한다.