...
{
private:
    CVIBuffer_Skybox(const ComPtr<ID3D12Device>& _device);
...
public:
    ...
    static CVIBuffer_Skybox* Create(const ComPtr<ID3D12Device>& _device, ID3D12GraphicsCommandList* _commandList);
