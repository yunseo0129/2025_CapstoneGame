...
public:
    ...
    // [Fracture] 조각(본) 오프셋 매트릭스 배열 -> centerBind 추출용
    const _float4x4* Get_BoneOffsetMatrices() const { return m_BoneOffsetMatrices.data(); }
...
public:
    static CMesh* Create(EngineContext* pContext, CModel::TYPE eModelType, class CModel* pModel, _fmatrix PreTransformMatrix);
