...
class CPlayer_Chick final : public CContainerObj
{
public:
    struct PLAYER_CHICK_DESC : public CContainerObj::CONTAINEROBJ_DESC
    {
...
private:
    CPlayer_Chick(EngineContext* pContext);
    CPlayer_Chick(const CPlayer_Chick& Prototype);
    virtual ~CPlayer_Chick() = default;
...
public:
    static CPlayer_Chick* Create(EngineContext* pContext);
