...
void CShader_Manager::Create_InputLayouts ()
{
	...
	m_LayoutAnim.push_back ( { "BLENDINDICES", 0, DXGI_FORMAT_R32G32B32A32_UINT, 0, 44, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 } );
	m_LayoutAnim.push_back ( { "BLENDWEIGHT",  0, DXGI_FORMAT_R32G32B32A32_FLOAT,0, 60, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 } );
