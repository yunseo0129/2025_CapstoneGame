...
CObjectShader::CObjectShader(const ComPtr<ID3D12Device>& _device, const ComPtr<ID3D12RootSignature>& _rootSignature)
{
...
CSkyboxShader::CSkyboxShader(const ComPtr<ID3D12Device>& _device, const ComPtr<ID3D12RootSignature>& _rootSignature)
{
	vector<D3D12_INPUT_ELEMENT_DESC> inputLayout = {
	{ "POSITION", 0, DXGI_FORMAT_R32G32B32_FLOAT, 0, 0, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 } };
